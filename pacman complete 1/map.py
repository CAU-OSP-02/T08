...
from constant import BIG_BLOCK_SIZE, BIG_GHOST_VALID_DISTANCE, BIG_WALL_VALID_DISTANCE, ITEM_VALID_DISTANCE, ONE_BLOCK_SIZE, COIN_VALID_DISTANCE, WALL_VALID_DISTANCE, GHOST_VALID_DISTANCE, COIN_SCORE, GHOST_NORMAL_STEP, ItemType, StuffType
...
class GameMap:
    ...
    def check_stuff_is_in_pacman_boundary(self, pacman_x_diff, pacman_y_diff, stuff_x, stuff_y, stuff_type):
        ...
        if stuff_type == StuffType.COIN:
            ...
            if self.pacman.block:
                valid_distance = BIG_WALL_VALID_DISTANCE
            else:
