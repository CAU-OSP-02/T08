...
gamemap = [
        ...
        ['벽', 'x', 'x', 'x', 'x', 'x', 'x','벽','벽', '벽', 'x', 'x', 'x', 'x', 'x','벽'],
        ['벽', 'x', 'x', 'x', 'x', 'x', 'x','x','x', 'x', 'x', 'x', 'x', 'x', 'x','벽'],
        ['벽', '벽', '벽', '벽', 'x', 'x', 'x','x','귀신', 'x', 'x', 'x', '벽', '벽', '벽','벽'],
   ...
   for x in range(len(gamemap)):
        for y in range(len(gamemap[x])):
            if gamemap[x][y] == '벽':
                ...
                gamepad.blit(resized_ghost, (x*one_blocksize, y*one_blocksize))
...
def move_ghost():
    ...
    current_x, current_y = find_ghost()
...
def main():
    global resized_tree, resized_pacman, resized_dot, resized_zero, resized_ghost
    ...
    resized_ghost = pygame.transform.scale(ghost, (one_blocksize,one_blocksize))
